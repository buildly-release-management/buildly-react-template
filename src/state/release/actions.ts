...
const loadReleases = (context: any, event: any) =>
...
const submitRelease = (context: any, event: any) =>
  new Promise((resolve, reject) => {
    const releaseService = new ReleaseService();
    return resolve(releaseService.submitRelease(event.release));
  });

const deleteRelease = (context: any, event: any) =>
  new Promise((resolve, reject) => {
    const httpService = new HttpService();
    return resolve(
      httpService
        .deleteItem(`/release/${event.release_uuid}/`, "release")
